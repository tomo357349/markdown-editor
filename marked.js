  ...
  while (src) {
    ...
    if (cap = this.rules.list.exec(src)) {
      ...
      for (; i < l; i++) {
        ...
        // CUSTOMIZE
        var isTodo = !!(/^ *[-] +/.exec(item));
        var isDone = !!(/^ *[+] +/.exec(item));
        ...
        this.tokens.push({
          // CUSTOMIZE
          todo: this.options.todo && isTodo,

          // CUSTOMIZE
          done: this.options.todo && isDone,
...
Renderer.prototype.code = function(code, lang, escaped) {
  ...
  // CUSTOMIZE: code class moves to pre tag
  // return '<pre><code class="'
  //  + this.options.langPrefix
  //  + escape(lang, true)
  return '<pre class="'
  + this.options.prePrefix
  + escape(lang, true)
    + '"><code class="'
    + this.options.langPrefix
    + escape(lang, true)
...
Renderer.prototype.listitem = function(text, todo, done) {
  // CUSTOMIZE
  // return '<li>' + text + '</li>\n';
...
Parser.parse = function(src, options, renderer) {
  // CUSTOMIZE: bug fix/renderer argument is not used.
...
Parser.prototype.tok = function() {
  switch (this.token.type) {
    ...
    case 'list_item_start': {
      ...
      // CUSTOMIZE
      var todo = this.token.todo;
      var done = this.token.done;
      ...
      return this.renderer.listitem(body, todo, done);
    }
...
function marked(src, opt, callback) {
  ...
  try {
    ...
    console.timeEnd('lexer');
    console.time('parser');
    var res = Parser.parse(tokens, opt);
    console.timeEnd('parser');
    return res;
  } catch (e) {
